                ...
                <div class="card-body">
                    <form action="{{ route('pegawais.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mt-2">
                            <label for="position_id" class="col-md-4 col-form-label text-md-right">Posisi<span class="text-danger">*</span></label>
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal_bergabung" type="date" class="form-control @error('tanggal_bergabung') is-invalid @enderror" name="tanggal_bergabung" value="{{ old('tanggal_bergabung') }}" required>
                        ...
                        <div id="buat_user_fields" style="display: none;">
                            ...
                            <div class="form-group row mt-2">
                                <label for="hak_akses" class="col-md-4 col-form-label text-md-right">Hak Akses<span class="text-danger">*</span></label>
                            
                                <div class="col-md-6">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('hak_akses') is-invalid @enderror" type="radio" name="hak_akses" id="admin" value="Admin" >
                                        <label class="form-check-label" for="admin">Admin</label>
                                    </div>
                            
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('hak_akses') is-invalid @enderror" type="radio" name="hak_akses" id="user" value="User" >
